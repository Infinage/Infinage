...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/kael/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/kael/.local/share/qutebrowser/userscripts/*')
...
# Fonts
config.set("fonts.web.family.standard", 'Fira Code Nerd Font')
