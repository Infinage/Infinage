...
-- Helper: dump selected entries into a scratch split
local function dump_selected_to_split(selected)
...
fzf.setup({
  git = {
    commits = {
      ...
      actions = { ["ctrl-q"] = dump_selected_to_split, },
      winopts = {
        preview = {
          layout = "vertical",
          horizontal = "right:40%",
